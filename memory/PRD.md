...
- Belum dikerjakan sama sekali: `savings_goals`/`savings_deposits`, `arisan_*` — masih di tahap desain (`docs/DATA_MODEL.md`), belum ada baris kode. Ini prasyarat sebelum landing page di-redesain dengan hero "Saku Aman" (keputusan user: bangun fitur dulu baru redesign, biar copy landing tidak menjanjikan sesuatu yang belum ada — fitur Saku Aman-nya sendiri SUDAH selesai sekarang, jadi redesign landing bisa lanjut).
